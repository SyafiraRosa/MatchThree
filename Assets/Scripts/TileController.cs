...
public class TileController : MonoBehaviour
{
    ...
    public static readonly Vector2 sizeBig = Vector2.one * 1.2f;
    public static readonly Vector2 sizeSmall = Vector2.zero;
    public static readonly Vector2 sizeNormal = Vector2.one;
